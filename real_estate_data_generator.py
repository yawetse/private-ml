...
@mo.capture(clear_on_run=True) # Re-run this cell to generate new data
def create_buyers_df(generate_buyers):
...
@mo.capture(clear_on_run=True) # Re-run this cell to generate new data
def create_houses_df(generate_houses):
...
@mo.capture(clear_on_run=True) # Re-run this cell to generate new data
def create_sales_df(generate_past_sales, df_buyers, df_houses):
...
@mo.capture(clear_on_run=True) # Re-run this cell to generate new data
def create_basic_transcripts_df(generate_basic_transcripts, df_buyers):
...
@mo.capture(clear_on_run=True) # Re-run this cell to generate new data
def create_llm_transcripts_df(generate_llm_transcripts, df_buyers, client):
